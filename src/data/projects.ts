...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A lightweight React-based educational site explaining the Injective ecosystem — what it is, what it was built for, and how it fits into the broader Web3 and DeFi landscape. My first bounty win, and where my on-chain journey began.',
  ...
  },
  {
    ...
    description: 'A Django website I built for an auto repair shop where I did my SIWES 1 internship. I pitched the idea of a website to the owner, and he paid me to build it for him. This was my first paid web development project.',
    stack: ['Python', 'Django', 'HTML', 'CSS'],
    github: 'https://github.com/SamuelOluwayomi/tunnelautocare',
    image: '/tunnelautocare.png',
    status: 'ARCHIVED',
  },
  {
    id: 'trust',
    exhibit: 'EXHIBIT L',
    name: 'Trust',
    description: 'A ZK-powered undercollateralized lending protocol built on HashKey Chain. DeFi lending normally demands heavy overcollateralization. Trust changes that by combining World ID for Sybil-resistant identity verification and Credit Soulbound Tokens to let trustworthy borrowers access loans beyond their collateral value — without revealing sensitive personal data. Built for the HashKey Chain On-Chain Horizon Hackathon.',
    stack: ['Next.js', 'Hardhat', 'Supabase', 'World ID', 'HashKey Chain', 'ZK Proofs', 'Solidity'],
    github: 'https://github.com/SamuelOluwayomi/Trust',
    live: 'https://trust-zk.vercel.app/',
    image: '/trust.png',
    status: 'SHIPPED',
  },
  {
    ...
    exhibit: 'EXHIBIT M',
    name: 'CadPay INJ',
    description: 'An AI-powered subscription payment platform built on Injective for the Injective Solo AI Builder Sprint. Users subscribe to digital services and pay with INJ — with an AI layer that helps manage payments, suggests subscriptions, and handles wallet interactions conversationally. Built to show how AI can make onchain payments as simple as asking a question.',
    stack: ['Next.js', 'TypeScript', 'Injective SDK', 'Groq API', 'LLaMA-3.3'],
    github: 'https://github.com/SamuelOluwayomi/Hodegos',
    live: 'https://hodegos.vercel.app/',
    image: '/cadpay-inj.png',
    status: 'SHIPPED',
  },
  {
    id: 'cadpay-kaspa',
    exhibit: 'EXHIBIT N',
    name: 'CadKas',
    description: 'A payment platform built on Kaspa for the Kaspathon hackathon. Kaspa\'s millisecond block times make it one of the fastest PoW chains in existence — CadKas takes advantage of that speed to build a subscription and payment system that feels genuinely instant. Built under the Payments & Commerce track.',
    stack: ['Next.js', 'TypeScript', 'Kaspa SDK', 'React'],
    github: 'https://github.com/SamuelOluwayomi/CadPay-Kaspathon',
    live: 'https://cadkas.vercel.app/',
    image: '/cadpay-kaspathon.png',
    status: 'SHIPPED',
  },
];
